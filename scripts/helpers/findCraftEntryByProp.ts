...
export function resolveCraftIdToSanityId(entryId: number, siteId: number): string {
  const manualPagesIds: Record<number, string> = {
    ...
    // TODO temp fix? July 31 2024
    // Understanding the Braze Core Values video page
    6669: '32bb7c2c-42d7-4087-b365-272dfa3a5e88',
    // TODO temp fix? July 31 2024
    // Bonfire Fireside: Talking Retention and Growth with Flink video page
    424257: '973ba6fe-b65c-4b63-a6a1-519c38714c4c',
    // braze for engineering
    38271: '1ea345f5-6c88-48eb-94b4-6bcc20e81076',
  }
